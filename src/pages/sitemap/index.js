...
let Sitemap = () => {
  const data = useStaticQuery(graphql`
    query Sitemap {
      ...
      subchannels: allMarkdownRemark(
        filter: { frontmatter: { templateKey: { eq: "category-subcategory" } } }
      ) {
        edges {
          node {
            fields {
  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content="Sitemap on RUN BGD with links to different sections of the site like channels, authors, social networks, our web app, and other links."
        />
      </Helmet>
      <main>
        <h1>Sitemap</h1>
