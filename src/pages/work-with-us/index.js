...
const WorkWithUsPage = () => {
    ...
    query WorkWithUsData{
            page: markdownRemark(frontmatter:{templateKey: {eq: "work-with-us-page"}}){
                frontmatter{
                    heroVideoCover{
                        publicURL
                    }
    ...
    return(
        <Layout fullWidth={true}>
            <section class={styles.videoSection}>
                <div className={styles.background}>
                    <video className={styles.fullWidthImage} autoPlay muted loop={true}>
                        <source src={data.page.frontmatter.heroVideoCover.publicURL} type="video/mp4" />
                    </video>
            ...
            <section className={styles.aboutSection} id='about'>
                <div className={styles.background}>
                    <Image className={styles.fullWidthImage} fluid={data.page.frontmatter.aboutImageCover.childImageSharp.fluid}/>
                    <div className={styles.overlay}>
                    </div>
                </div>
            ...
            {data.page.frontmatter.sections.map((section, index) => {
                return <section key={index} className={styles.longTextSection}>
                <div className={styles.background}>
                    <Image className={styles.fullWidthImage} fluid={section.coverImage.childImageSharp.fluid}/>
                    <div className={styles.overlay}>
                    </div>
                </div>
