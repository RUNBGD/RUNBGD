    ...
    return(
        <Layout>
            <Helmet>
                ...
                <meta name="description" content={`Welcome to RUN BGD Shop Cart. Here you can see everything you choose to buy from our official RUN BGD Shop.`} />
            </Helmet>
            <main>
            <h1>Cart</h1>
            ...
            {products.length > 0 ?
                ...
                <div className={styles.emptyCartContainer}>
                    ...
                    <p>Currently there are no items in your cart. You can find our merch in <br/><Link to='/shop'>shop</Link></p>
                </div>
            }
            </div>
            </main>
