...
const AboutPage = () => {
  ...
  const slideDown = useSpring({
    from: {
      transform:
        currentSlide == 5 ? 'translate(0%, -150%)' : 'translate(0%, 0%)',
    },
    to: {
      transform:
        currentSlide == 5 ? 'translate(0%, 0%)' : 'translate(0%, -150%)',
    },
    delay: 100,
  })
  ...
  const slideRight = useSpring({
    from: {
      transform:
        currentSlide == 3 ? 'translate(150%, 0%)' : 'translate(0%, 0%)',
    },
    to: {
      transform:
        currentSlide == 3 ? 'translate(0%, 0%)' : 'translate(150%, 0%)',
    },
    delay: 100,
  })
  ...
  const slideLeft = useSpring({
    from: {
      transform:
        currentSlide == 4 ? 'translate(-150%, 0%)' : 'translate(0%, 0%)',
    },
    to: {
      transform:
        currentSlide == 4 ? 'translate(0%, 0%)' : 'translate(-150%, 0%)',
    },
    delay: 100,
  })
  ...
  return (
    <Layout verticalSlider={true}>
      <div
        ...
        onClick={nextSlide}
        onWheel={(e) => {
          return e.deltaY > 0 ? nextSlide() : prevSlide()
        }}
        onTouchMove={(e) => {
          e.persist()
          setTouchMoves((prevState) => {
            return [...prevState, e.changedTouches]
          })
        }}
        onTouchEnd={() => setTouchMoves([])}
      >
        {appearTransition.map(({ item, key, props }) => {
          return (
            item && (
              <animated.div
                style={props}
                className={styles.verticalSliderSlide}
              >
                <div
                ...
                >
                  <animated.div style={slideUp} className={styles.lStack}>
                    ...
                    <h2>SCROLL OR CLICK TO READ ABOUT US</h2>
                  </animated.div>
                </div>
              </animated.div>
            )
              ...
              >
                ...
                >
                  <animated.div style={slideRight} className={styles.lStack}>
                    <h2>
                      WE PRESENT BELGRADE AS TOURISTIC DESTINATION IN A LITTLE
                      DIFFERENT LIGHT
                    </h2>
                  </animated.div>
                </div>
              ...
              >
                ...
                >
                  <animated.div style={slideLeft} className={styles.lStack}>
                    <h2>
                      WE MAINLY WANT TO INTRODUCE BELGRADE TO THE YOUNG PEOPLE
                      OF EUROPE
                    </h2>
                  </animated.div>
                </div>
