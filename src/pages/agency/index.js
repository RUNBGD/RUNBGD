            ...
            fullWidthContent={
                <div style={{overflowX:'hidden'}}>
                    <div className={styles.heroBanner}>
                        ...
                        }}>{data.page.frontmatter.heroBannerHeading}</animated.h1>
                        <div className={styles.backgroundImageFixed}>
                            <Image fluid={data.page.frontmatter.heroBannerImage.childImageSharp.fluid} alt=''/>
                        </div>
                    </div>
                    {
                        ...
                        if(section.type == 'heading'){
                            ...
                            return(
                                <section className={`${styles.contentSection} ${section.imageOnRight && styles.reverseSection}`} style={{backgroundColor: `#${section.backgroundColor}`}}>
                                    <SectionImage image={section.image.childImageSharp.fluid} imageOnRight={section.imageOnRight}/>
